...
type PerkStyleSelectionDto = { perk: number; var1: number; var2: number; var3: number };
...
type BanDto = { championId: number; pickTurn: number };
type ObjectivesDto = {
  baron: ObjectiveDto;
...
type ObjectiveDto = { first: boolean; kills: number };
